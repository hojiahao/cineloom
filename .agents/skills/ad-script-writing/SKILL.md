...
5. Budget words: Mandarin voiceover reads at about 4 characters per second, so at most 18 characters per 5 s beat, fewer if the beat has on-screen text. Count them.
